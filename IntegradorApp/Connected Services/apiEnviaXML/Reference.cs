...
namespace IntegradorApp.apiEnviaXML {
    ...
    public interface ServicoEnviarLoteEventos {
        ...
        IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse EnviarLoteEventos(IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventos", ReplyAction="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventosResponse")]
        System.Threading.Tasks.Task<IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse> EnviarLoteEventosAsync(IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest request);
    }
    ...
    public partial class EnviarLoteEventosRequest {
        ...
        public IntegradorApp.apiEnviaXML.EnviarLoteEventosRequestBody Body;
        
        public EnviarLoteEventosRequest() {
        }
        
        public EnviarLoteEventosRequest(IntegradorApp.apiEnviaXML.EnviarLoteEventosRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class EnviarLoteEventosResponse {
        ...
        public IntegradorApp.apiEnviaXML.EnviarLoteEventosResponseBody Body;
        
        public EnviarLoteEventosResponse() {
        }
        
        public EnviarLoteEventosResponse(IntegradorApp.apiEnviaXML.EnviarLoteEventosResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServicoEnviarLoteEventosChannel : IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicoEnviarLoteEventosClient : System.ServiceModel.ClientBase<IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos>, IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos.EnviarLoteEventos(IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest request) {
        ...
        public System.Xml.Linq.XElement EnviarLoteEventos(System.Xml.Linq.XElement loteEventos) {
            IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest inValue = new IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest();
            inValue.Body = new IntegradorApp.apiEnviaXML.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse retVal = ((IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos)(this)).EnviarLoteEventos(inValue);
            return retVal.Body.EnviarLoteEventosResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse> IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos.EnviarLoteEventosAsync(IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest request) {
            return base.Channel.EnviarLoteEventosAsync(request);
        }
        
        public System.Threading.Tasks.Task<IntegradorApp.apiEnviaXML.EnviarLoteEventosResponse> EnviarLoteEventosAsync(System.Xml.Linq.XElement loteEventos) {
            IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest inValue = new IntegradorApp.apiEnviaXML.EnviarLoteEventosRequest();
            inValue.Body = new IntegradorApp.apiEnviaXML.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            return ((IntegradorApp.apiEnviaXML.ServicoEnviarLoteEventos)(this)).EnviarLoteEventosAsync(inValue);
        }
    }
}
