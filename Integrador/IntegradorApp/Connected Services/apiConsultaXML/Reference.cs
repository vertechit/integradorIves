...
namespace IntegradorApp.apiConsultaXML {
    ...
    public interface ServicoConsultarLoteEventos {
        ...
        IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse ConsultarLoteEventos(IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/consulta/retorno" +
            "Processamento/v1_1_0/ServicoConsultarLoteEventos/ConsultarLoteEventos", ReplyAction="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/consulta/retorno" +
            "Processamento/v1_1_0/ServicoConsultarLoteEventos/ConsultarLoteEventosResponse")]
        System.Threading.Tasks.Task<IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse> ConsultarLoteEventosAsync(IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest request);
    }
    ...
    public partial class ConsultarLoteEventosRequest {
        ...
        public IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequestBody Body;
        
        public ConsultarLoteEventosRequest() {
        }
        
        public ConsultarLoteEventosRequest(IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ConsultarLoteEventosResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="ConsultarLoteEventosResponse", Namespace="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/consulta/retorno" +
            "Processamento/v1_1_0", Order=0)]
        public IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponseBody Body;
        
        public ConsultarLoteEventosResponse() {
        }
        
        public ConsultarLoteEventosResponse(IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServicoConsultarLoteEventosChannel : IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicoConsultarLoteEventosClient : System.ServiceModel.ClientBase<IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos>, IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos.ConsultarLoteEventos(IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest request) {
        ...
        public System.Xml.Linq.XElement ConsultarLoteEventos(System.Xml.Linq.XElement consulta) {
            IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest inValue = new IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest();
            inValue.Body = new IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequestBody();
            inValue.Body.consulta = consulta;
            IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse retVal = ((IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos)(this)).ConsultarLoteEventos(inValue);
            return retVal.Body.ConsultarLoteEventosResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse> IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos.ConsultarLoteEventosAsync(IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest request) {
            return base.Channel.ConsultarLoteEventosAsync(request);
        }
        
        public System.Threading.Tasks.Task<IntegradorApp.apiConsultaXML.ConsultarLoteEventosResponse> ConsultarLoteEventosAsync(System.Xml.Linq.XElement consulta) {
            IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest inValue = new IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequest();
            inValue.Body = new IntegradorApp.apiConsultaXML.ConsultarLoteEventosRequestBody();
            inValue.Body.consulta = consulta;
            return ((IntegradorApp.apiConsultaXML.ServicoConsultarLoteEventos)(this)).ConsultarLoteEventosAsync(inValue);
        }
    }
}
