...
namespace Vertech.apiEnviaXML {
    ...
    public interface ServicoEnviarLoteEventos {
        ...
        Vertech.apiEnviaXML.EnviarLoteEventosResponse EnviarLoteEventos(Vertech.apiEnviaXML.EnviarLoteEventosRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventos", ReplyAction="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventosResponse")]
        System.Threading.Tasks.Task<Vertech.apiEnviaXML.EnviarLoteEventosResponse> EnviarLoteEventosAsync(Vertech.apiEnviaXML.EnviarLoteEventosRequest request);
    }
    ...
    public partial class EnviarLoteEventosRequest {
        ...
        public Vertech.apiEnviaXML.EnviarLoteEventosRequestBody Body;
        
        public EnviarLoteEventosRequest() {
        }
        
        public EnviarLoteEventosRequest(Vertech.apiEnviaXML.EnviarLoteEventosRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class EnviarLoteEventosResponse {
        ...
        public Vertech.apiEnviaXML.EnviarLoteEventosResponseBody Body;
        
        public EnviarLoteEventosResponse() {
        }
        
        public EnviarLoteEventosResponse(Vertech.apiEnviaXML.EnviarLoteEventosResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServicoEnviarLoteEventosChannel : Vertech.apiEnviaXML.ServicoEnviarLoteEventos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicoEnviarLoteEventosClient : System.ServiceModel.ClientBase<Vertech.apiEnviaXML.ServicoEnviarLoteEventos>, Vertech.apiEnviaXML.ServicoEnviarLoteEventos {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Vertech.apiEnviaXML.EnviarLoteEventosResponse Vertech.apiEnviaXML.ServicoEnviarLoteEventos.EnviarLoteEventos(Vertech.apiEnviaXML.EnviarLoteEventosRequest request) {
        ...
        public System.Xml.Linq.XElement EnviarLoteEventos(System.Xml.Linq.XElement loteEventos) {
            Vertech.apiEnviaXML.EnviarLoteEventosRequest inValue = new Vertech.apiEnviaXML.EnviarLoteEventosRequest();
            inValue.Body = new Vertech.apiEnviaXML.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            Vertech.apiEnviaXML.EnviarLoteEventosResponse retVal = ((Vertech.apiEnviaXML.ServicoEnviarLoteEventos)(this)).EnviarLoteEventos(inValue);
            return retVal.Body.EnviarLoteEventosResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Vertech.apiEnviaXML.EnviarLoteEventosResponse> Vertech.apiEnviaXML.ServicoEnviarLoteEventos.EnviarLoteEventosAsync(Vertech.apiEnviaXML.EnviarLoteEventosRequest request) {
            return base.Channel.EnviarLoteEventosAsync(request);
        }
        
        public System.Threading.Tasks.Task<Vertech.apiEnviaXML.EnviarLoteEventosResponse> EnviarLoteEventosAsync(System.Xml.Linq.XElement loteEventos) {
            Vertech.apiEnviaXML.EnviarLoteEventosRequest inValue = new Vertech.apiEnviaXML.EnviarLoteEventosRequest();
            inValue.Body = new Vertech.apiEnviaXML.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            return ((Vertech.apiEnviaXML.ServicoEnviarLoteEventos)(this)).EnviarLoteEventosAsync(inValue);
        }
    }
}
